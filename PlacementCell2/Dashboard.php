      ...
      Column
       ...
       <div class="section one my-5" id="section1">
          <h2>Educational background</h2><BR>
            ...
            <h5 class="sub_heading my-4">Class XII</h5>
            <table>
            <tr valign="top">
              <?php
            ...
            // Roll no.:<br>
            // Marksheet:<br> -->
            <h5 class="sub_heading my-4">Graduation</h5>
            <table>
            <tr valign="top">
              <?php
         ...
         <div class="section one my-5" id="section2">
          ...
          <table>
            ...
            <hr class="main">
    <div class="section one my-5" id="section2">
      <h2>Links</h2><BR><!-- if it has been added other wise provide button to add one-->
        <div class="inner_text">
          Website_name:Link...</br>
        </div>
        </div>
        <hr class="main">
        <div class="section one my-5" id="section1">
