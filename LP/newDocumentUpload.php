...
<div class=" container-fluid">
		<div class="row flex-nowrap">
           ...
           <li class="aq nav-item pb-3">
                        ...
                        <li class="nav-item pb-3">
							<a href="newexamcenter.php" class="nav-link align-middle px-0">
								<i class="fs-4 bi-window-stack"></i> <span class="ms-1 d-none d-sm-inline ">Exam Center Selection</span>
							</a>
						</li>
                        <li class="nav-item pb-3">
      ...
      <div class="mt-4 ps-4 pe-5 " style="width:1030px;">
        <div class="d-flex justify-content-between">
          ...
          <form class="form form-horizontal hr row gy-2 gx-3 bg-light rounded-2 shadow"method="post" enctype="multipart/form-data">
            <h5 class="fw-bold" style="padding-top: 20px; padding-left: 10px;">Document Upload </h5>

            <div class="row"style="padding-top: 20px;">
                <div class="col-md-12 mt-3">
                    <input class="form-control" type="file" id="formFile" name="candidate_photo" required>
                    <label class="form-label" for="Candidatephoto">Candidates Photograph (with 80% face without mask) (jpg, jpeg)</label>
                    <img src="./image/<?php echo $query['Candidate_Photo']; ?>">
                </div>
            </div>

            <div class="row"style="padding-top: 20px;">
                <div class="col-md-12 mt-3">
                    <input class="form-control" type="file" id="formFile" name="candidate_signature" required>
                    <label class="form-label" for="Candidatesignature">Candidates Signature (jpg, jpeg)</label>
                </div>
            </div>

            <div class="row"style="padding-top: 20px;">
                <div class="col-md-12 mt-3">
                    <input class="form-control" type="file" id="formFile" name="candidate_category_Cert">
                    <label class="form-label" for="Candidatecategory">Category Certificate (pdf) </label>
                </div>
            </div>

            <div class="row mb-3">
                <div class="save col-md-6  mt-3">
                    <input type="submit" class="btn btn-info" value="Submit" name="DocUpload">
                </div>
            </div>
...
require '../vendor/autoload.php';
    ...
    if (isset($_POST['DocUpload'])) {
        ...
        $filename = $_FILES["candidate_photo"]["name"];
    
        //$tempname = $_FILES["candidate_photo"]["tmp_name"];  
        echo $filename;
       
            $folder = "uploads/";   
    
            // query to insert the submitted data
    $doc=array('Candidate_Photo'=>$filename,"Email"=> $email);
    $collection->insertOne($doc);
            // Add the image to the "image" folder"
    
            if ( move_uploaded_file($_FILES['candidate_photo']['tmp_name'], 'C:\xampp\htdocs\MCA-3rd-sem-Project\LP\uploads'.$filename)) {
