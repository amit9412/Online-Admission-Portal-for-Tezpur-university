...
if(chkLogin())
{
    if(isset($_POST['pwotpsubmit'])){
      $curr_otp = $_POST['newotp'];
  $otp = $query["otp"];
        if ($curr_otp == $otp) {
          ...
          <div class="col d-flex justify-content-center">
            <div class="card shadow-lg p-3 mb-5 bg-white rounded" style=" width: 500px ;
              ...
              <div class="card-body p-3 shadow-5 ">
                <h2 class="fw-bold mb-5 text-center">Forgot Password OTP Verification?</h2>

                <form method="POST" >
                <div class="form-group">
        <div class="form-group">
          <label class="" for="enterotp">Enter OTP sent to your email to change your password</label>
          <div class="input-group pt-2">

            <input name="newotp" type="text" class="form-control form-control-sm" id="newotp" placeholder="Enter OTP" required>
...
<p id="message"></p>
      ...
      <button id="submitBtn" class="btn btn-md btn-primary btn-block" type="submit" name="pwotpsubmit">Submit
                </button>
